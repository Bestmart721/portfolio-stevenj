...
export default function GoAigua(props) {
  ...
  return (
    <>
      <Head>
      <title>Steven J - Portfolio - Goaigua</title>
        <meta name="description" content="Projects and use cases working at Idrica making Goaigua as a Senior Web Developer and UX Engineer"/>
